...
System.out.println("total amount of pay in a year : ₹ "+total);
System.out.println("lowest amount of the year     : ₹ "+minAmount);
System.out.println("highest amount of the year    : ₹ "+ maxAmount);
